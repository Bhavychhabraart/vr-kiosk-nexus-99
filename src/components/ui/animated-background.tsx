...
const AnimatedBackground = ({
  ...
  const renderParticles = () => {
    ...
    return <>
        ...
        <div className="orb bg-vr-secondary/20 w-80 h-80 -bottom-20 -right-20 animate-spin-slow" style={{
        animationDelay: "-5s"
      }}></div>
        <div className="orb bg-vr-accent/20 w-72 h-72 top-1/3 right-1/4 animate-spin-slow" style={{
        animationDelay: "-3s"
      }}></div>
      </>;
  };
  return <div className={cn("relative overflow-hidden", className)} {...props}>
      {renderParticles()}
      <div className="relative z-10 bg-neutral-950">{children}</div>
    </div>;
};
