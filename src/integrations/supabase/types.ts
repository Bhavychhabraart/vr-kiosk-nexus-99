  ...
  public: {
    ...
    Functions: {
      ...
      assign_machine_admin_role: {
        Args: { p_granted_by?: string; p_user_id: string; p_venue_id: string }
        Returns: Json
      }
      create_machine_admin_invitation: {
        Args: { p_email: string; p_invited_by: string; p_venue_id: string }
        Returns: Json
      }
      ...
      set_admin_password: {
        Args: { p_enabled?: boolean; p_password: string; p_venue_id: string }
        Returns: Json
      }
