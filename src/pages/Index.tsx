...
const Index = () => {
  ...
  const gameCategories = [
    { id: 1, name: "Action", icon: <Sword size={24} className="text-vr-accent" /> },
    { id: 2, name: "Adventure", icon: <Gamepad2 size={24} className="text-vr-secondary" /> },
    { id: 3, name: "Puzzle", icon: <Star size={24} className="text-yellow-500" /> },
    { id: 4, name: "Simulation", icon: <Clock size={24} className="text-vr-primary" /> }
  ];
  ...
  return (
    <MainLayout className="space-y-8">
      <section className="text-center mt-4">
        <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold bg-gradient-to-r from-vr-primary to-vr-secondary bg-clip-text text-transparent">
          Welcome to VR Kiosk
        </h1>
        <p className="text-vr-muted mt-3 max-w-2xl mx-auto">
          Explore amazing virtual reality experiences. Select a game to begin your journey.
        </p>
      </section>
                ...
                <div>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <Button 
                      ...
                      onClick={() => navigate(`/games/${game.id}?showTrailer=true`)}
                    >
                      Watch Trailer
                    </Button>
                  </div>
          ...
          {featuredGames.map((_, index) => (
            <button
              ...
              className={`h-2 w-2 rounded-full transition-colors ${
                index === currentFeaturedIndex ? "bg-vr-secondary" : "bg-vr-text/30"
              }`}
